...
function accountaFriendsComments(state=[], action){
    if (action.type === 'SET_ACCOUNTA_FRIENDS_COMMENTS') {
        return action.payload;
    }
    return state;
}
...
export {accountaFriends, accountaFriendsGoals, accountaFriendsReflections, accountaFriendsActionPlans, accountaFriendsComments};